...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            menuBackground.GetComponent<Renderer>().material.color = new Color(234f / 255f, 185f / 255f, 217f / 255f);
                ...
                transform =
        {
            ...
            if (disconnectButton)
            {
                ...
                disconnectbutton.GetComponent<Renderer>().material.color = new Color(175f / 255f, 123f / 255f, 156f / 255f);
            ...
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, -0.39f);
            gameObject.GetComponent<Renderer>().material.color = new Color(175f / 255f, 123f / 255f, 156f / 255f);
                ...
                transform =
        {
            ...
            component.localPosition = new Vector3(0.06f, 0f, -0.11f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
            ...
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.06f, 0.9f, 0.09f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, -0.29f);
            gameObject.GetComponent<Renderer>().material.color = new Color(175f / 255f, 123f / 255f, 156f / 255f);
                ...
                transform =
        {
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.06f, 0f, -0.148f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
            ...
            {
                CreateButton(i * 0.11f, activeButtons[i]);
            }
        }
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.GetComponent<Renderer>().material.color = new Color(0.749f, 0.749f, 1f); 
            ...
            component.localPosition = new Vector3(.06f, 0, 0.104f - offset / 2.6f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
        ...
        {
            foreach (ButtonInfo[] buttons in AetherTemp.Menu.Buttons.buttons)
            {
